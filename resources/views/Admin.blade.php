          ...
          <div class="col-lg-6">
            <div class="card">
              <div class="card-body">
                ...
                <p class="card-text">
                  please click the link below to add
                </p>
          ...
          <div class="col-lg-6">
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                ...
                <p class="card-text">Here are the data that has been created</p>
              </div>
                <table>
                    <tr>
                        <th>ID.</th>
                    ...
                    @foreach($data as $dat)
                        <tr>
                            <td>{{ $dat['id']  }}</td>
                            <td>
                                <img src="{{ $dat['file_url']  }}" style="max-width: 50%; max-height: 50%;">
                            </td>
                            <td>{{ $dat['title']  }}</td>
                            <td>{{ $dat['description']  }}</td>
                            <td>
                                <form method="POST" action="{{ route('delete_porto', ['id' => $dat['id']])  }}">
                                    @csrf
                                    @method('DELETE')
                            ...
                            <td>
                                <form method="GET" action="{{ route('form_update_porto', ['id' => $dat['id']])  }}">
                                    @csrf
